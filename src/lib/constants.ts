  ...
  navMain: [
    {
      title: "Ana Sayfa",
      url: "/dashboard",
      iconName: "Home", // Use iconName and string
    },
    {
      title: "Şablonlar",
      url: "/templates",
      iconName: "FileText", // Use iconName and string matching NavMain map
    },
    {
      title: "Çöp Kutusu",
      url: "/trash",
      iconName: "Trash", // Use iconName and string
    },
    {
      title: "Ayarlar",
      url: "/settings",
      iconName: "Settings", // Use iconName and string
    },
  ],
};
...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    slideBackgroundColor: "#ffffff",
    accentColor: "#b5838d",
    gradientBackground: "linear-gradient(135deg, #f7e8e8 0%, #e5ecec 100%)",
    navbarColor: "#e5ecec",
    sidebarColor: "#f7e8e8",
    type: "light",
  },
  {
    ...
    slideBackgroundColor: "#ffffff",
    accentColor: "#00a68b",
    gradientBackground: "linear-gradient(135deg, #0077be 0%, #00a68b 100%)",
    navbarColor: "#0077be",
    sidebarColor: "#005c8f",
    type: "dark",
  },
...
export const layouts: LayoutGroup[] = [
  {
    ...
    layouts: [
      ...
      {
        name: "Three Columns with heading",
...
export const component: ComponentGroup[] = [
  ...
  },
  {
    ...
    components: [
      {
        componentType: "bulletList1",
        name: "Bullet List Level 1",
        type: "component",
        component: BulletListComponent,
        icon: "▦",
      },
      {
        componentType: "bulletList2",
        name: "Bullet List Level 2",
        type: "component",
        component: BulletListComponent,
        icon: "▦",
      },
      {
        componentType: "bulletList3",
        name: "Bullet List Level 3",
        type: "component",
        component: BulletListComponent,
        icon: "▦",
      },
      {
        componentType: "numberedList1",
        name: "Numbered List Level 1",
        type: "component",
        component: NumberedListComponent,
        icon: "▦",
      },
      {
        componentType: "numberedList2",
        name: "Numbered List Level 2",
        type: "component",
        component: NumberedListComponent,
        icon: "▦",
      },
      {
        componentType: "numberedList3",
        name: "Numbered List Level 3",
        type: "component",
        component: NumberedListComponent,
        icon: "▦",
      },
